...
def main():
    ...
    def win():
        ...
        if event.type == pg.MOUSEBUTTONUP and left_click:
            ...
            if next_level.collidepoint(pos):
                ...
                not_text = font.render("Under Construction", True, (0, 0, 0))
    ...
    # 設定說明區塊
    note = "There is a 30% possibility of this enemy attacking twice."
            ...
            if battle and event.type == pg.MOUSEBUTTONUP and left_click:
                ...
                if player == False and enemy_hp > 0:
                    ...
                    if second_attack >= 8 and bt_hp.count(0) != 4:
                        ...
                        while enemy_atk:
                            ...
                            if bt_hp[i] == 0:
                                ...
                                status_text = "Enemy made a double attack."
                                status_update(status_text)
                                status_text = bt_name[i] + " was hurt by a " + str(enemy_atk) + " hit."
                                status_update(status_text)
                    ...
                    if second_target:
                        if target - enemy_atk <= 0 and target != 0:
                            bt_hp[i] = 0
                            status_text = bt_name[i] + " was unable to fight."
                            status_update(status_text)
                            sound = pg.mixer.Sound("audio\\01._damage_grunt_male.wav")
                            sound.play()
                            sound.set_volume(0.2)
