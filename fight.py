...
def main():
    ...
    status_line_lim = 9
    status_lst = []
    status_text = "每一關需在回合數內擊敗敵人"
    status_update(status_text)
    status_text = "請點擊角色區塊攻擊敵人"
    status_update(status_text)

    # 設定說明區塊
    note = "滑鼠右鍵點擊角色區塊可以查看各角色的攻擊特色"
    ...
    while running:
        ...
        if battle and rect_char1.collidepoint(pos):
            pass
        ...
        for event in pg.event.get():
            ...
            # 點擊角色區塊
            if battle and player and event.type == pg.MOUSEBUTTONUP and left_click:
                if rect_char1.collidepoint(pos):
                    ...
                    if bt_hp[0] == 0:
                        ...
                        player = False
                    status_update(status_text)
                elif rect_char2.collidepoint(pos):
                    ...
                    if bt_hp[1] == 0:
                        ...
                        player = False
                    status_update(status_text)
                elif rect_char3.collidepoint(pos):
                    ...
                    if bt_hp[2] == 0:
                        ...
                        player = False
                    status_update(status_text)
                elif rect_char4.collidepoint(pos):
